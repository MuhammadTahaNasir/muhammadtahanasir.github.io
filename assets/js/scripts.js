...
function showSection(section) {
  ...
  let placeholderText = 'Look for posts or projects…';
  if (section === 'tags') {
          ...
          case 'skills':
            ...
            const skills = {
              ...
              'AI/ML & Data Science': [
                ...
                '<strong>Vector Databases</strong>: Pinecone, Weaviate, ChromaDB',
              ...
              'Tools & Tech': ['Jupyter, Google Colab, Anaconda', 'MLflow, n8n', '<strong>Additional</strong>: CUDA'],
...
function displayProjects(projects) {
  ...
  latestProjects.forEach(project => {
    ...
    let cardContent = `
      ...
      <a href="${project.url}" style="display: block; margin-top: auto; padding: 8px 16px; background: #3b82f6; color: #fff; text-decoration: none; border-radius: 6px; font-size: 0.8em; font-weight: 600; transition: background 0.3s ease; text-align: center;">View Project</a>
    `;
...
window.addEventListener('popstate', () => {
  ...
  if (askBar && window.location.pathname.includes('index.html')) {
    ...
    askBar.innerHTML = `
      <input type="text" placeholder="Look for posts or projects…" autocomplete="off">
      <button aria-label="Send"><i class="fas fa-chevron-right"></i></button>
