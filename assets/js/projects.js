...
function applyFilter() {
    ...
    filteredProjects.forEach(project => {
        ...
        const webLink = project.hideWebLink ? '' : `<a href="${project.web || project.url}" target="_blank" rel="noopener noreferrer" class="web-link" title="Visit Website"><i class="fas fa-globe"></i></a>`;
        ...
        card.innerHTML = `
            ...
            <div class="content-container">
                ...
                <div class="project-links">
                    ${webLink}
                    ${project.github ? `<a href="${project.github}" target="_blank" rel="noopener noreferrer" class="github-link" title="View on GitHub"><i class="fab fa-github"></i></a>` : ''}
                </div>
            </div>
        `;
